package com.project.assets.api;

import com.project.assets.logging.TraceContext;
import com.project.assets.model.ErrorResponse;
import com.project.assets.model.AssetSourceType;
import com.project.assets.service.AssetAggregationException;
...
public class ErrorHandlingAdvice {
    ...
    public ResponseEntity<ErrorResponse> handleAssetAggregationException(AssetAggregationException ex) {
        Map<String, Object> details = Map.of(
                "failedSources", ex.getFailedSources().stream().map(AssetSourceType::name).toList()
        );
        ErrorResponse response = ErrorResponse.of(
